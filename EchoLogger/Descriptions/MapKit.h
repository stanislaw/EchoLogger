...
static inline NSString * __attribute__((overloadable)) EchoLoggerDescription(MKCoordinateRegion region) {
...
static inline NSString * __attribute__((overloadable)) EchoLoggerDescription(MKMapRect rect) {
...
static inline NSString * __attribute__((overloadable)) EchoLoggerDescription(MKMapPoint point) {
...
static inline NSString * __attribute__((overloadable)) EchoLoggerDescription(MKMapSize size) {
